...
function SideTabItem({
  ...
  const {
    colors
  } = (0, _native.useTheme)(); // For a good UX the navBar must bea at least 2x 
  ...
  let multiplier = _reactNative.Platform.OS === 'android' ? 2.3 : 2; // If the icons been showed as vertical we dont neet apply the 
