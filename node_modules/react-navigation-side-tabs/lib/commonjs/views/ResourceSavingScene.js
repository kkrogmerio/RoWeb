...
class ResourceSavingScene extends React.Component {
  render() {
    if (_reactNativeScreens.screensEnabled === null || _reactNativeScreens.screensEnabled === void 0 ? void 0 : (0, _reactNativeScreens.screensEnabled)()) {
      const _this$props = this.props,
            {
        isVisible
      } = _this$props,
            rest = _objectWithoutProperties(_this$props, ["isVisible"]);
