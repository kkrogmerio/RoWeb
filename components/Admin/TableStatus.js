    ...
    return (
      <View style={styles.statusScreen}>
        <View style={[styles.statusTable,{backgroundColor:'#9dd155'}]}>
          ...
          <Text style={[fontStyle.fontStatusTable,{fontSize:12}]}>{STATUS_TABLE.FREE}</Text>
        </View>
        <View style={[styles.statusTable,{backgroundColor:'#f4d055'}]}>
          <Text style={fontStyle.fontStatusTable}>5 </Text>
          <Text style={[fontStyle.fontStatusTable,{fontSize:12}]}>{STATUS_TABLE.BUSY}</Text>
        </View>
        <View style={[styles.statusTable,{backgroundColor:'#f5484f'}]}>
          <Text style={fontStyle.fontStatusTable}>3 </Text>
          <Text style={[fontStyle.fontStatusTable,{fontSize:12}]}>{STATUS_TABLE.OVERSTAYED}</Text>
        </View>
        <View style={[styles.statusTable,{backgroundColor:'#a864a8'}]}>
          <Text style={fontStyle.fontStatusTable}>2 </Text>
          <Text style={[fontStyle.fontStatusTable,{fontSize:12}]}>{STATUS_TABLE.NEED_SERVICES}</Text>
        </View>
        <View style={[styles.statusTable,{backgroundColor:'#00a99d'}]}>
          <Text style={fontStyle.fontStatusTable}>3 </Text>
          <Text style={[fontStyle.fontStatusTable,{fontSize:12}]}>{STATUS_TABLE.NO_WAITERS} </Text>
          <Image style={{width:17.5,height:17.5}} source={require('../../assets/icons/nowaiters.png') }/>
        </View>
